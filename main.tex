...
%
    ...
    \begin{prop}
        Let $L_\bullet$ be a partionifold on 
    \end{prop}
		...
		Next we prove that $\phi_t^X$ is a diffeomorphism. In fact it suffices to prove that $\phi_t^X$ is a local diffeomorphism since it has already been proven to be injective. As such we let $m \in M$ be given and aim to prove that $\phi_t^X$ is a diffeomorphism in some open nbhd of $m$. \bigskip
